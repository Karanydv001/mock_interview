...
// Make sure this is the client SDK, not admin
            ...
            <div className="flex flex-col gap-6 card  py-14 px-10">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-6 mt-4 form">
                       ...
                       <Formfeild control={form.control} name="email" label="Email" placeholder="Enter your address" type="email"/>
...
// Removed local stub for createUserWithEmailAndPassword; using Firebase client SDK instead.
